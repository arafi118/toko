	  ...
	  <div class="row">
		<div class="col-sm-12">
			<div class="box box-warning">
			  <div class="box-header">
				<i class="fa fa-exclamation-triangle text-yellow" aria-hidden="true"></i>
				  <h3 class="box-title">Penjualan Produk Terlaris @show_tooltip(__('tooltip.produk_terlaris')) </h3>
				  <div class="box-tools pull-right">
					<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
				</div>
				</div>
					...
					<table class="table table-bordered table-striped " id="sales_payment_dues_table">
						...
						<tfoot>
							<tr class="bg-gray font-17 footer-total text-center">
								...
								<td><span class="display_currency" id="footer_tot_hut" data-currency_symbol ="true"></span></td>
								<td></td>
							</tr>
						</tfoot>
					</table>
	              ...
	              <table class="table table-bordered table-striped" id="purchase_payment_dues_table">
					...
					<tfoot>
						<tr class="bg-gray font-17 footer-total text-center">
							<td colspan="2"><strong>Total</strong></td>
							{{-- <td><strong>Hutang:</strong></td> --}}
							<td><span class="display_currency" id="footer_hut_beli" data-currency_symbol ="true"></span></td>
							{{-- <td></td> --}}
						</tr>
					</tfoot>
				</table>
