...
@section('content')
    ...
    @if (auth()->user()->can('dashboard.data'))
        ...
        <section class="content no-print">
            <div class="box mt-3 hidden">
                <div class="box-body">
                    Yth. Mitra PT. Asta Brata Teknologi <br>
                    <br>
                    For Your Information <br>
                    <br>
                    Untuk sementara seluruh aktivitas layanan Technical Support Apps dialihkan ke Nomor : <br>
                    <b style="font-size: 16px">+62 882-0066-44656</b> <br>
                    <br>
                    Silakan Registrasikan Ulang Nomor Anda ke Nomor Technical Support Baru dengan cara di bawah ini : <br>
                    Nama Lengkap : <br>
                    Unit Toko Kec : <br>
                    Request : <br>
                    <br>
            ...
            <div class="row">
                <div class="{{ session('business.enable_product_expiry') == 1 ? 'col-sm-6' : 'col-sm-12' }}">
                    <div class="box box-warning">
                        <div class="box-header">
                            <i class="fa fa-exclamation-triangle text-yellow" aria-hidden="true"></i>
                            <h3 class="box-title">{{ __('home.product_stock_alert') }}
                ...
                @if (session('business.enable_product_expiry') == 1)
                    <div class="col-sm-6">
                        <div class="box box-warning">
                            <div class="box-header">
                                <i class="fa fa-exclamation-triangle text-yellow" aria-hidden="true"></i>
                                <h3 class="box-title">{{ __('home.stock_expiry_alert') }} @show_tooltip(
                                    __('tooltip.stock_expiry_alert', [ 'days' =>session('business.stock_expiry_alert_days',
                                    30) ]) )
                                </h3>
                                <div class="box-tools pull-right">
                                    <button type="button" class="btn btn-box-tool" data-widget="collapse">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="box box-warning">
                        <div class="box-header">
                            <i class="fa fa-exclamation-triangle text-yellow" aria-hidden="true"></i>
                            <h3 class="box-title">Daftar Pembelian Barang @show_tooltip(__('tooltip.produk_supp')) </h3>
                            <div class="box-tools pull-right">
                        ...
                        <div class="box-body">
                            <table class="table table-bordered table-striped" id="daftar_beli">
                                <thead>
                                    <tr>
                                        <th>Produk</th>
                                        <th>Supplier</th>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="box box-warning">
                        <div class="box-header">
                            <i class="fa fa-exclamation-triangle text-yellow" aria-hidden="true"></i>
                            <h3 class="box-title">Penjualan Produk Terlaris @show_tooltip(__('tooltip.produk_terlaris'))
                            </h3>
                            <div class="box-tools pull-right">
                                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i
                                        class="fa fa-minus"></i></button>
                        ...
                        <div class="box-body">
                            <table class="table table-bordered table-striped" id="produk_terlaris">
                                <thead>
                                    <tr>
                                        <th>Produk</th>
            ...
            <div class="row">
                    ...
                    <div class="box box-warning">
                        <div class="box box-widget">
                            <div class="box-header with-border">
                                <i class="fa fa-exclamation-triangle text-yellow" aria-hidden="true"></i>
                                <h3 class="box-title">{{ __('lang_v1.sales_payment_dues') }}
                                    ...
                                    <table class="table table-bordered table-striped " id="sales_payment_dues_table">
                                        ...
                                        <tfoot>
                                            <tr class="bg-gray font-17 footer-total text-center">
                                                ...
                                                <td><span class="display_currency" id="footer_tot_hut"
                ...
                <div class="col-sm-6">
                    <div class="box box-warning">
                        <div class="box-header">
                            <i class="fa fa-exclamation-triangle text-yellow" aria-hidden="true"></i>
                            <h3 class="box-title">{{ __('lang_v1.purchase_payment_dues') }}
                            ...
                            <table class="table table-bordered table-striped" id="purchase_payment_dues_table">
                                ...
                                <tfoot>
                                    <tr class="bg-gray font-17 footer-total text-center">
                                        <td colspan="2"><strong>Total</strong></td>
                                        {{-- <td><strong>Hutang:</strong></td> --}}
                                        <td><span class="display_currency" id="footer_hut_beli"
                                                data-currency_symbol="true"></span></td>
                                        {{-- <td></td> --}}
                                    </tr>
                                </tfoot>
