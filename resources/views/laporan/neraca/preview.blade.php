...
<body>
	...
	<table width="96%" border="1" style="border-collapse: collapse;" align="center" cellpadding="3" cellspacing="0" class="style9">
			...
			<td style="vertical-align: top;" class="left top bottom" width="50%">
				<table width="100%" cellpadding="0" cellspacing="0" class="style9">	
					<tbody>
						...
						<?php if ($r->idrekening != $jr) if ($jr != 'all') continue; ?>
						<tr>
							<td><strong>{{$r->nama_rr}}</strong><br> 
								...
								<?php 	
							        ...
							        $dt_aktiva = NeracaAwalBulan::where('business_id', $business_id)->where('tanggal', "$thn-$bln-01")->where('kd_jb', $ch->kd_jb);
						...
						<tr>
							<td><strong>{{$r->nama_rr}}</strong><br> 
								...
								<?php 	
								    ...
								    $dt_passiva = NeracaAwalBulan::where('business_id', $business_id)->where('tanggal', "$thn-$bln-01")->where('kd_jb', $ch->kd_jb); 	
	    ...
	    <tr>
		  <th height="30" class="left top bottom" style="text-align: right;"><span class="pull-right">{{number_format($ttl_aktiva, 2)}}</span></th>
		  <th class="all" style="text-align: right;"><span class="pull-right" >{{number_format($ttl_passiva + $laba_rugi, 2)}}</span></th>
	    </tr>
		<tr>
