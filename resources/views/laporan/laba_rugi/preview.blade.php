...
<body>
            ...
            <tr>
                <td height="20" colspan="2" class="bottom" width="5%">
                    <div class="style9 text-align-left"><img class="" alt="..." src="{{ url($path) }}"
                            style="float:left; width:50; margin-right:5px;" width="70"></div>
                </td>
                <td class="bottom">
                    <div class="style9">
    ...
    ?>
    <h3 style="text-align: center;"><br>LAPORAN RUGI LABA <br> {{ $tgl != null ? $tgl : '' }}
        {{ Request::get('bln') != null ? strtoupper(array_search(Request::get('bln'), array_flip($bulan))) : strtoupper(array_search(date('m'), array_flip($bulan))) }}
        {{ Request::get('thn') != null ? Request::get('thn') : '' }}</h3>
