    ...
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label>Inisial:*</label>
            {!! Form::text('initial', null, ['class' => 'form-control', 'required', 'placeholder' =>'Inisial'
            ,'id'=>'initial']); !!}
          </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
          ...
          $legalitation = [
          'Tidak Ada' => 'Tidak Ada',
          'Sebagai Direktur' => 'Sebagai Direktur',
          'Bag. Keuangan' => 'Bag. Keuangan',
          'Pengawas' => 'Pengawas',
          ]
          @endphp
          <div class="form-group">
            {!! Form::label('legalitation', 'Legalisasi Laporan') !!}
            {!! Form::select('legalitation', $legalitation, null, ['class' => 'form-control select2']); !!}
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              {!! Form::text('username', null, ['class' => 'form-control', 'required', 'placeholder' => __(
              'business.username' ) ]); !!}
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            {!! Form::text('confirm_password', null, ['class' => 'form-control', 'required', 'placeholder' => __(
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            {!! Form::number('cmmsn_percent', null, ['class' => 'form-control', 'placeholder' => __(
            'lang_v1.cmmsn_percent' ), 'step' => 0.01 ]); !!}
          </div>
        </div>
