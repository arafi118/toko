    ...
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label>Inisial:*</label>
            {!! Form::text('initial', $user->initial, ['class' => 'form-control', 'required', 'placeholder' =>'Inisial'
            ,'id'=>'initial']); !!}
          </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
          ...
          <div class="form-group">
            ...
            {!! Form::select('legalitation', $legalitation, $user->legalitation, ['class' => 'form-control select2']);
            !!}
          </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            {!! Form::text('confirm_password', null, ['class' => 'form-control', 'placeholder' => __(
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            {!! Form::number('cmmsn_percent', $user->cmmsn_percent, ['class' => 'form-control', 'placeholder' => __(
