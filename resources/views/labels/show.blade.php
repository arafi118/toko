				...
				<div class="col-sm-8 col-sm-offset-2">
					<div class="form-group">
						<div class="input-group">
							...
							'search_product_for_label', 'placeholder' =>
							__('lang_v1.enter_product_name_to_print_labels'), 'autofocus']); !!}
						</div>
					</div>
				</div>
			</div>
		...
		<div class="box-body">
			<div class="row">
				<div class="col-sm-3">
					<div class="checkbox">
						<label>
							<input type="checkbox" checked name="print[name]" value="1"> <b>@lang( 'barcode.print_name'
								)</b>
						</label>
					</div>
				</div>
				...
				<div class="col-sm-3">
					<div class="checkbox">
						<label>
							<input type="checkbox" checked name="print[price]" value="1" id="is_show_price"> <b>@lang(
				...
				<div class="col-sm-3" id="price_type_div">
					<div class="form-group">
						...
						<div class="input-group">
							...
							{!! Form::select('print[price_type]', ['inclusive' => __('product.inc_of_tax'), 'exclusive'
							=> __('product.exc_of_tax')], 'inclusive', ['class' => 'form-control']); !!}
						</div>
					</div>
				</div>
				...
				<div class="col-sm-3">
					<div class="form-group">
						{!! Form::label('print[type_card]', @trans( 'barcode.type_card' ) . ':') !!}
						<div class="input-group">
							<span class="input-group-addon">
								<i class="fa fa-credit-card"></i>
							</span>
							<select name="print[type_card]" id="print[type_card]" class="form-control type-card">
								<option value="price_tag">Label Harga</option>
								<option value="price_card">Label Daftar Harga</option>
							</select>
							{{-- {!! Form::select('print[type_price]', ['inclusive' => __('product.inc_of_tax'), 'exclusive'
							=> __('product.exc_of_tax')], 'inclusive', ['class' => 'form-control']); !!} --}}
						</div>
					</div>
				</div>
				<div class="col-sm-3" style="display: none;" id="print-style">
					<div class="form-group">
						{!! Form::label('print[print_style]', @trans( 'barcode.print_style' ) . ':') !!}
						<div class="input-group">
							<span class="input-group-addon">
								<i class="fa fa-list-alt"></i>
							</span>
							<select name="print[print_style]" id="print[print_style]" class="form-control">
				...
				<div class="col-sm-4">
					<div class="form-group barcode-set">
