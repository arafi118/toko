...
<section class="content">
      ...
      <div class="row">
        ...
        <div class="col-sm-4 @if(!session('business.enable_brand')) hide @endif">
          <div class="form-group">
            ...
            <div class="input-group">
              {!! Form::select('brand_id', $brands, $product->brand_id, ['placeholder' => __('messages.please_select'),
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <button type="button" @if(!auth()->user()->can('unit.create')) disabled @endif class="btn btn-default
                  bg-white btn-flat quick_add_unit btn-modal"
                  data-href="{{action('UnitController@create', ['quick_add' => true])}}" title="@lang('unit.add_unit')"
        ...
        {{-- <div class="col-sm-4 ">
          <div class="form-group">
            ...
            <div class="input-group">
              {!! Form::select('rak_id', $rak_bar, $product->id_letak_barang, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
            <span class="input-group-btn">
                <button type="button" @if(!auth()->user()->can('brand.create')) disabled @endif class="btn btn-default bg-white btn-flat btn-modal" data-href="{{action('SimpanBarangController@create', ['quick_add' => true])}}"
        title="Tambah Rak" data-container=".view_modal"><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
        </span>
      </div>
    </div>
  </div> --}}
  <div class="col-sm-4">
    <div class="form-group">
      {!! Form::label('rak_id', 'Rak Penyimpanan' . ':*') !!}
      <div class="input-group">
        {!! Form::select('rak_id', $rak_bar, $product->id_letak_brg, ['placeholder' => __('messages.please_select'),
        'class' => 'form-control select2']); !!}
        <span class="input-group-btn">
          <button type="button" @if(!auth()->user()->can('brand.create')) disabled @endif class="btn btn-default
            bg-white btn-flat btn-modal" data-href="{{action('SimpanBarangController@create', ['quick_add' => true])}}"
            title="Tambah Rak" data-container=".view_modal"><i
              class="fa fa-plus-circle text-primary fa-lg"></i></button>
        </span>
      </div>
    </div>
        ...
        <div class="col-sm-4">
          <div class="checkbox">
            <label>
              ...
              <strong>@lang('lang_v1.enable_imei_or_sr_no')</strong> @show_tooltip(__('lang_v1.tooltip_sr_no'))
            </label>
          </div>
        </div>
      ...
      <div class="text-center">
        <div class="btn-group">
          ...
          <button type="submit" @if(empty($product->enable_stock)) disabled="true" @endif id="opening_stock_button"
            value="update_n_edit_opening_stock" class="btn bg-purple
          ...
          {{-- <button type="submit" value="update_n_add_quantity"
            class="btn btn-success submit_product_form">@lang('lang_v1.update_n_add_quantity')</button> --}}
