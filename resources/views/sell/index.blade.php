                        ...
                        <table class="table table-bordered table-striped ajax_view" id="sell_table">
                            ...
                            <tfoot>
                                <tr class="bg-gray font-17 footer-total text-center">
                                    ...
                                    <td><span class="display_currency" id="footer_total_remaining"
                                            data-currency_symbol ="true"></span></td>
                                    <td></td>
                                </tr>
                            </tfoot>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#sell_date_filter').daterangepicker(
                dateRangeSettings,
                function(start, end) {
                    $('#sell_date_filter span').html(start.format(moment_date_format) + ' ~ ' + end.format(
                        moment_date_format));
            ...
            sell_table = $('#sell_table').DataTable({
                ...
                "ajax": {
                    "url": "/sells",
                    "data": function(d) {
                        var start = $('#sell_date_filter').data('daterangepicker').startDate.format(
                            'YYYY-MM-DD');
                        var end = $('#sell_date_filter').data('daterangepicker').endDate.format(
                            'YYYY-MM-DD');
                        d.start_date = start;
                        d.end_date = end;
                        d.is_direct_sale = 1;
                ...
                "fnDrawCallback": function(oSettings) {
                    ...
                    $('#footer_total_remaining').text(sum_table_col($('#sell_table'),
                        'total-remaining'));
