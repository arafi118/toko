                    ...
                    <div class="box-body">
                        ...
                        @if (!empty($price_groups))
                            @if (count($price_groups) > 1)
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        {!! Form::label('price_group', __('sale.selling_price_group') . ':') !!}
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                            ...
                                            {!! Form::text('hidden_price_group', key($price_groups), ['id' => 'hidden_price_group', 'class' => 'hidden']) !!}
