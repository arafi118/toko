                        ...
                        <div class="@if (!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::text('transaction_date', $trans_date, ['class' => 'form-control', 'required']) !!}
                                </div>
                            </div>
                        </div>
                        @php
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::text('cashback_amount', @num_format($transaction->cashback_amount), [
                                            'class' => 'form-control input_number',
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('sale_note', $transaction->additional_notes, [
                                        'class' => 'form-control',
                                        'rows' => '1',
                                        'cols' => '30',
                                    ]) !!}
