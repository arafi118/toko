@foreach( $variations as $variation)
    <tr>
        ...
        <td class="{{$hide_tax}}">
            <span class="row_subtotal_before_tax display_currency hidden">0</span>
            <input type="text" class="form-control input-sm input_number row_subtotal_before_tax_hidden" value=0>
        </td>
        <td class="{{$hide_tax}}">
