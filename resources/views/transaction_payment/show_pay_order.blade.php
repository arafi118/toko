<div class="modal-lg modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title no-print">Pembayaran DP Pre-Order 
        ...
        @if($transaction->payment_status != 'paid')
          <div class="row">
            ...
            @if((auth()->user()->can('purchase.payments') && (in_array($transaction->type, ['purchase', 'purchase_return']) )) || (auth()->user()->can('sell.payments') && (in_array($transaction->type, ['sell', 'sell_return']))))
              <a href="{{ action('TransactionPaymentController@addPayOrder', [$transaction->id]) }}" class="btn btn-primary btn-xs pull-right add_payment_modal no-print"><i class="fa fa-plus" aria-hidden="true"></i> Pelunasan Pre-Order</a>
            @endif
