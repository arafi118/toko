...
{{-- @php
    dd(in_array('access_default_selling_price',$role_permissions));
@endphp --}}
<!-- Main content -->
      ...
      <div class="row check_group">
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'sell.sell_list', in_array('sell.sell_list', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.sell.sell_list' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
