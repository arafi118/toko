...
<section class="content">
	...
	<div class="box">
    {!! Form::open(['url' => action('PembayaranHutangController@store'), 'method' => 'post', 'id' => 'pembayaran_hutang_form' ]) !!}
          ...
          <div class="row">
            <div class="col-md-4">
               ...
               <div class="form-group">
                   ...
                   <input type="hidden" name="sisa_hutang" id="sisa_hutang" value="{{$tp->amount - $terbayar->terbayar}}">
               </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="{{route('hapus_pembayaran_hutang',['id'=>$ut->id,'payment_id'=>$ut->id_payment])}}"><i class="fa fa-trash"></i></a></td>
            </tr>
            <?php $ttl += $ut->nominal ?>
            @endforeach
            <tr>
