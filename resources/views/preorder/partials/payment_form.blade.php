<div class="row">
	...
	@endphp
	{{-- <div class="{{$col_class}}">
		<input type="checkbox" name="is_hutang_piutang" id="is_hutang_piutang"> {{Request::segment(1) == 'purchases' ? 'Hutang' : 'Piutang'}}
	</div> --}}
	...
	<div class="{{$col_class}}">
		<div class="form-group">
			{!! Form::label("depe_po" , 'DP Pre-Order:*') !!}
			<div class="input-group">
				<span class="input-group-addon">
					<i class="fa fa-money"></i>
				</span>
				{!! Form::text("depe_po", null, ['class' => 'form-control pre_order_depe input_number','required', 'id' => "depe_po", 'placeholder' => "Angka"]); !!}
			</div>
		</div>
	</div>
	<style>
