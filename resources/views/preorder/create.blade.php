...
@section('title', 'Tambah Pre-Order')
...
@section('content')
    ...
    <section class="content no-print">
        ...
        {!! Form::open(['url' => action('PreOrderController@store'), 'method' => 'post', 'id' => 'add_preorder_form']) !!}
        <div class="row">
...
@else
    ...
    @endif
             @endif -->
                        ...
                        <div class="@if (!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
                            <div class="form-group">
                                {!! Form::label('transaction_date', 'Tanggal Pre-Order:*') !!}
                                <div class="input-group">
                                    <span class="input-group-addon">
        ...
        <div class="box box-solid" id="payment_rows_div"><!--box start-->
            ...
            <div class="box-body payment_row">
                @include('preorder.partials.payment_form', ['row_index' => 0])
                <hr>
                {{-- <div class="row">
				<div class="col-sm-12">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <button type="button" id="submit-print"
                            class="btn btn-success pull-right btn-flat">@lang('messages.subpr')</button>
                    </div>
                </div>
            </div>
        </div>
...
@section('javascript')
    ...
    <script src="{{ asset('js/preorder.js?v=' . $asset_v) }}"></script>
