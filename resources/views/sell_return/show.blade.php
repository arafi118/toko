<div class="modal-dialog modal-xl no-print" role="document">
  <div class="modal-content">
    ...
    <h4 class="modal-title" id="modalTitle"> @lang('lang_v1.sell_refund') (<b>@lang('sale.invoice_no'):</b> {{ $sell->return_parent->invoice_no }})
    </h4>
</div>
<div class="modal-body">
   <div class="row">
      <div class="col-sm-6 col-xs-6">
        <h4>@lang('lang_v1.sell_refund_details'):</h4>
        <strong>@lang('lang_v1.refund_date'):</strong> {{@format_date($sell->return_parent->transaction_date)}}<br>
  ...
  <div class="row">
    <div class="col-sm-6 col-sm-offset-6 col-xs-6 col-xs-offset-6">
      <table class="table">
        ...
        <tr>
          <th>@lang('lang_v1.refund_total'):</th>
          <td></td>
