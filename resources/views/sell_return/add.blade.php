...
@extends('layouts.app')
@section('title', __('lang_v1.sell_refund'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header no-print">
    <h1>@lang('lang_v1.sell_refund')</h1>
</section>
		...
		<div class="box-body">
					...
					<table class="table bg-gray" id="sell_return_table">
			          	<thead>
				            <tr class="bg-green">
				              	...
				              	<th>@lang('lang_v1.refund_quantity')</th>
				              	<th>@lang('lang_v1.refund_subtotal')</th>
				            </tr>
						</thead>
						{{-- @php
							dd($sell);
				        ...
				        <tbody>
				            ...
				            <tr>
				              	...
				              	<td>
						            ...
						            @endphp
						            <input type="text" name="products[{{$loop->index}}][quantity]" value="{{@num_format($sell_line->quantity_returned)}}" required
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						<div class="input-group">
							...
							{!! Form::select("method", $payment_types, 'cash', ['class' => 'form-control col-md-12 payment_types_dropdown', 'required', 'id' => "method", 'style' => 'width:100%;']); !!}
						</div>
					</div>
				</div>
				<div class="col-sm-4">
			...
			<div class="row">
				<div class="col-sm-12 text-right">
					<strong>@lang('lang_v1.total_refund_discount'):</strong> 
				...
				<div class="col-sm-12 text-right">
					<strong>@lang('lang_v1.refund_total'): </strong>&nbsp;
