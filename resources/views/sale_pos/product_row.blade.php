<tr class="product_row" data-row_index="{{$row_count}}">
	...
	<td>
		...
		<div class="input-group input-number">
			...
			<input data-variation-id="{{$product->variation_id}}" data-product="{{ $product->product_id }}" type="text"
				data-min="1" class="form-control pos_quantity input_number mousetrap"
	...
	<td class="text-center">
		<i data-variation="{{$product->variation_id}}" class="fa fa-close text-danger pos_remove_row cursor-pointer"
			aria-hidden="true"></i>
	</td>
</tr>