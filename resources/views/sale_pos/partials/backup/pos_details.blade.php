							...
							<tr>
								<td colspan="5">
									...
									<span id="total_payable" class="text-success lead text-bold"
										style="font-size: 28px">0</span>
								</td>
								{{-- <td colspan="2">
									<div class="">

										<div class="col-sm-2 col-no-padding hidden">
											...
											<button type="button" class="btn btn-info btn-block btn-flat"
												id="pos-quotation" disabled>@lang('lang_v1.quotation')</button>
										</div>

										<div class="col-sm-12 col-no-padding">

											<div class="col-sm-12 col-2px-padding">
												<button type="button"
