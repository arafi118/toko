<div class="row">
    ...
    @endphp
    <div class="{{ $col_class }}">
        <input type="checkbox" name="is_hutang_piutang" id="is_hutang_piutang">
        {{ Request::segment(1) == 'purchases' ? 'Hutang' : 'Piutang' }}
    </div>
    ...
    <div class="{{ $col_class }}">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text('bayar', @num_format($payment_line['amount']), [
