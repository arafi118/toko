<div class="row">
	...
	@endphp
	{!! Form::hidden("payment[$row_index][amount]", @num_format($payment_line['amount']), ['class' =>
	'form-control payment-amount input_number text-2xl font-medium', 'required','readonly', 'id' =>
	"amount_$row_index",'style'=>'border:0px; text-align: right; margin-bottom:0;', 'placeholder' =>
	__('sale.amount')]); !!}
	<div class="col-md-12">
		<div class="row">
		    ...
		    <div class="col-md-12">
		        <div class="form-group">
					...
					<div class="input-group">
						...
						{!! Form::text('transaction_date', $transaction_date, ['class' => 'form-control', 'required', 'id' => 'transaction_date']); !!}
					</div>
				</div>
		    </div>
		    @endif
			...
			<div class="col-md-12">
				<div class="form-group">
					...
					<div class="input-group">
						...
						['class' =>
						'form-control col-md-12 payment_types_dropdown', 'required', 'id' =>
						"method_$row_index", 'style' =>
						'width:100%;']); !!}
					</div>
				</div>
			</div>
			...
			<div class="col-md-12">
				<div class="form-group">
					...
					<div class="input-group">
						...
						!empty($payment_line['account_id']) ?
						$payment_line['account_id'] : '' , ['class' => 'form-control select2', 'id' =>
						"account_$row_index",
						'style' => 'width:100%;']); !!}
					</div>
				</div>
	...
	<div class="col-md-5 hidden">
		<div class="form-group">
			...
			'placeholder' => __('sale.sell_note'),'style'=> 'height: 110px;']); !!}
		</div>
