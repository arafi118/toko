    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview {{  in_array( $request->segment(1), ['sells', 'pos', 'sell-return', 'preorder']) ? 'active active-sub' : '' }}"
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ $request->segment(1) == 'sells' && $request->segment(2) == null ? 'active' : '' }}"><a
                            href="{{action('SellController@index')}}"><i
                                class="fa fa-list"></i>@lang('lang_v1.all_sales')</a></li>
                    <li
                        class="{{ $request->segment(1) == 'preorder' && $request->segment(2) == null ? 'active' : '' }}">
                        <a href="{{action('PreOrderController@index')}}"><i class="fa fa-list"></i>Daftar Pre-Order</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a href="{{action('PreOrderController@create')}}"><i class="fa fa-plus-circle"></i>Tambah
                            Pre-Order</a></li>
                    @endcan
                    @can('sell.view')
                    <li class="{{ $request->segment(1) == 'pos' && $request->segment(2) == null ? 'active' : '' }}"><a
                            href="{{action('SellPosController@index')}}"><i
            ...
            <li class="{{ $request->segment(2) == 'laporan-sell-periode' ? 'active' : '' }}"><a
                    href="{{action('ReportController@getSellReportPeriode')}}"><i class="fa fa-list"></i>Daftar
        ...
        <li class="treeview {{ $request->segment(1) == 'stock-adjustments' ? 'active active-sub' : '' }}">
            ...
            <ul class="treeview-menu">
                ...
                <li
                    ...
                    <a href="{{action('StockAdjustmentController@getDaftarSO')}}"><i class="fa fa-list"></i>Daftar Stok
                        Opname</a></li>
                @endcan
                @can('purchase.create')
                <li
                    ...
                    <a href="{{action('StockAdjustmentController@getStockAdjustment')}}"><i
                            class="fa fa-plus-circle"></i>Tambah Stok Opname</a></li>
                @endcan
            </ul>
        </li>
        @endif
