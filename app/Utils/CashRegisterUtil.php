...
class CashRegisterUtil extends Util
{
    ...
    public function getRegisterDetails($register_id = null)
    {
        ...
        $query = CashRegister::join('cash_register_transactions as ct', 'ct.cash_register_id', '=', 'cash_registers.id')
        ...
        $register_details = $query->select(
            ...
            'cash_registers.closing_amount as closing_amount',
            'cash_registers.total_card_slips as total_card_slips_close',
            'cash_registers.total_cheques as total_cheques_close',
            'cash_registers.closing_note as closing_note_close',
    ...
    public function getTransactionSell($user_id, $open_time, $close_time)
    {
        $product_details = Transaction::where('transactions.created_by', $user_id)
            ->whereBetween('transaction_date', [$open_time, $close_time])
            ->where('transactions.type', 'sell')
