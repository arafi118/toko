...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'surname', 'first_name', 'last_name', 'username', 'email', 'initial', 'password', 'business_id', 'is_cmmsn_agnt', 'contact_no', 'address', 'cmmsn_percent', 'language', 'selected_contacts', 'legalitation'
    ];
